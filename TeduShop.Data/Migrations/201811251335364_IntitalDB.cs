namespace TeduShop.Data.Migrations
{
    ...
    public partial class IntitalDB : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        BirthDay = c.DateTime(),
                        Email = c.String(),
                        EmailConfirmed = c.String(nullable: false),
                        PasswordHash = c.String(),
                        SecurityStamp = c.String(),
                        PhoneNumber = c.String(),
                        PhoneNumberCofirmed = c.String(nullable: false),
                ...
                c => new
                    {
                        ...
                        CustomerMobie = c.String(nullable: false, maxLength: 50),
                ...
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        Name = c.String(nullable: false, maxLength: 50),
                        Depatment = c.String(maxLength: 50),
                ...
                c => new
                    {
                        ...
                        ValueString = c.String(nullable: false, maxLength: 50),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.IdentityUserRoles", "IdentityRoleID", "dbo.IdentityRoles");
            DropForeignKey("dbo.IdentityUserRoles", "ApplicationUserID", "dbo.ApplicationUsers");
            DropForeignKey("dbo.IdentityUserLogins", "ApplicationUserID", "dbo.ApplicationUsers");
            DropForeignKey("dbo.IdentityUserClaims", "ApplicationUserID", "dbo.ApplicationUsers");
            ...
            DropIndex("dbo.IdentityUserRoles", new[] { "ApplicationUserID" });
            DropIndex("dbo.IdentityUserRoles", new[] { "IdentityRoleID" });
            DropIndex("dbo.IdentityUserLogins", new[] { "ApplicationUserID" });
            DropIndex("dbo.IdentityUserClaims", new[] { "ApplicationUserID" });
